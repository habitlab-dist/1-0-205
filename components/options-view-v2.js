(function(){
  var polymer_ext, load_css_file, ref$, is_habitlab_enabled, enable_habitlab, get_goals, get_enabled_goals, list_all_goals, get_favicon_data_for_domain_cached, once_true, promise_all_object, msg, log_pagenav, swal;
